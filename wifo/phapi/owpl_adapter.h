...
#ifndef _OWPL_ADAPTER_HEADER_
#define _OWPL_ADAPTER_HEADER_

#include <phapi.h>

typedef int (* OWPL_LINE_CONFIGURATION_HOOK)
(
	OWPL_LINE line,
	void * user_data
) ;
...
*/
#ifndef OWSIPAccountMessageFilter
	#define OWSIPAccountMessageFilter void *
#endif
