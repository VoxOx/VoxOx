...
/**
 * Implements the Singleton for getting the GrowlNotifier instance
 */
//VOXOX CHANGE by Alexander 06-02-09: implemented Singleton to the Growl notifier
GrowlNotifier* GrowlNotifier::_instance = 0;

GrowlNotifier* GrowlNotifier::Instance()
{
	if (_instance == 0) {
		QStringList notifications;
		notifications << "Contact Online" << "Chat Message" << "Incoming Call";
		_instance = new GrowlNotifier(notifications, notifications, "VoxOx");
	}
