 ...
 * necessary when VoxOxFrame get replaced with QLabel 4.2
 *
 * @author Aurelien Gateau
 */
class VoxOxFrame : public QFrame
{
	Q_OBJECT
public:
	VoxOxFrame(QWidget* parent = 0);
	~VoxOxFrame();

	void hideBorder();//VOXOX CHANGE by Rolando - 2009.07.07 
	void showBorder();//VOXOX CHANGE by Rolando - 2009.07.07 

Q_SIGNALS:
	void mouseEntered();//VOXOX CHANGE by Rolando - 2009.07.07
	void mouseLeave();//VOXOX CHANGE by Rolando - 2009.07.07 
private:
	void enterEvent( QEvent * event );//VOXOX CHANGE by Rolando - 2009.07.07
	void leaveEvent ( QEvent * event );//VOXOX CHANGE by Rolando - 2009.07.07

	QString _currentStyleSheet;//VOXOX CHANGE by Rolando - 2009.07.07 
};

#endif // VOXOXLINKLABEL_H
