...
Hunspell * Hunspell::instance = NULL;
...
Hunspell *Hunspell::getInstance(const char * affpath, const char * dpath, const char * key) {


if (!instance) {
	instance = new Hunspell(affpath,dpath,key);
}
