...
#ifndef VOXOXLINKLABEL_H
#define VOXOXLINKLABEL_H
 ...
 * necessary when VoxOxLinkLabel get replaced with QLabel 4.2
 *
 * @author Aurelien Gateau
 */
class VoxOxLinkLabel : public QLabel
{
	Q_OBJECT
	Q_PROPERTY(QString link READ link WRITE setLink)

public:
	VoxOxLinkLabel(QWidget* parent = 0);
