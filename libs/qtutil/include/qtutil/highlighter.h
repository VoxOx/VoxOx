...
public:
    Highlighter(Hunspell * Checker,QTextDocument *parent = 0,QString SpellDic="",bool spellCheckState=false);
    ~Highlighter();
    void clearCheck();
	...
	//VOXOX - CJC - 2009.05.03 Add set method so not 2 variables are created
	void setHuspellChecker(Hunspell * Checker){pChecker = Checker;}
