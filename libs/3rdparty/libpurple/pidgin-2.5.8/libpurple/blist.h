...
//	void (*_purple_reserved1)(void);	//VOXOX - JRT - 2009.04.11 
	void (*_list_initial_load)(int);	/**Notify UI when a contact list is initially loaded and completed. */
															/** Allows UI to address issue with slow loading TreeWidget on startup. */
