	...
	} else if (g_str_equal(command, "CALL"))
	{
			...
			g_str_equal(string_parts[3], "RINGING"))
		{
			...
			if (g_str_equal(type, "INCOMING"))
			{
				...
				/*purple_request_action(gc, _("Incoming Call"), temp, //VOXOX - CJC - 2009.10.28 Remove request action because is making calls been default to accept, without skype ringing and user knowing about it
