...
#ifndef OWV4L2_PIXERTOOL_H
#define OWV4L2_PIXERTOOL_H
 ...
 *
 * Converts from v4l2 pixel format identifier to
 * pixer palette identifier
 *
 * @param pixel format identifier to convert
 ...
 * v4l2 palette identifier
 *
 * @param pix palette identifier to convert
 * @return equivalent v4l2 identifier
 */
