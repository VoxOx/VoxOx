...
//		result += ("<account>" + _imContact._imAccount->getUUID() + "</account>\n");	
		result += ("<account>" + const_cast<IMAccount*>(_imContact._imAccount)->getKey() + "</account>\n");		//VOXOX - JRT - 2009.04.24
	}
...
//		IMAccount *imAccount = _imAccountList.getIMAccount(accountUuidValue);
		IMAccount *imAccount = _imAccountList.findByKey( accountUuidValue );	//VOXOX - JRT - 2009.04.24 - uuidValue is a misnomer. Will addresss later.
		if (imAccount) {
