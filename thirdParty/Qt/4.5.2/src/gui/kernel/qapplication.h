...
class Q_GUI_EXPORT QApplication : public QCoreApplication
{
	...
	Q_PROPERTY(int voxToolTipDelay  READ voxToolTipDelay WRITE setVoxToolTipDelay)//VOXOX - CJC - 2009.11.05 
...
public:
	...
	static void setVoxToolTipDelay(int);//VOXOX - CJC - 2009.11.05 
    static int voxToolTipDelay();//VOXOX - CJC - 2009.11.05 
