...
#ifndef QTWIZARDPHONES_H
#define QTWIZARDPHONES_H
...
namespace Ui { class WizardPhones; }
 ...
 */
class QtWizardPhones : public QWidget, public QtIWizard {
	Q_OBJECT
public:

	QtWizardPhones(CWengoPhone & cWengoPhone, QWidget * parent);

	virtual ~QtWizardPhones();
