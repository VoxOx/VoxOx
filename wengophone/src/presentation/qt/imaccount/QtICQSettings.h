...
#ifndef OWQTICQSETTINGS_H
#define OWQTICQSETTINGS_H
...
class QWidget;
namespace Ui { class ICQSettings; }
 ...
 */
class QtICQSettings : public QtIMAccountPlugin {
	Q_OBJECT
public:

	QtICQSettings(UserProfile & userProfile, IMAccount & imAccount, QDialog * parent);
