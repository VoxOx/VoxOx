...
class QtEmoticonsWidget;//VOXOX CHANGE by Rolando - 2009.12.10 
class QtTranslationWidget;//VOXOX - CJC - 2010.01.18 

class QFont;

namespace Ui { class UMSMS; }
/**
 *
 ...
 */
class QtUMSMS : public QtUMBase {
	Q_OBJECT
public:


	QtUMSMS(CChatHandler & cChatHandler, CContactList & cContactList,
		IMChatSession * imChatSession, QWidget * parent,QString key,QtEnumUMMode::Mode mode = QtEnumUMMode::UniversalMessageChatToSMS);
...
//	void sendFileToSession(const QString & filename);	//VOXOX - JRT - 2009.07.27 - Not called anywhere.
	...
	//void unTabClickedSlot();//VOXOX CHANGE by Rolando - 2009.06.08 
